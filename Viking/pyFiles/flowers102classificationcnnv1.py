# -*- coding: utf-8 -*-
"""Flowers102ClassificationCNNv1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/ChrisO03/IMLO-CourseWork/blob/main/Flowers102ClassificationCNNv1.ipynb
"""
...
#Hyperparameters
lr = 0.00005 #Drop this down, too high
...
def train(dataloader, model, loss_fn, optimiser):
  ...
  for batch, (X, y) in enumerate(dataloader):
    ...
    running_loss += loss
    running_corrects += torch.count_nonzero(pred.argmax(1)==y)
...
def trainValLoop(model, loss_fn, optimiser, epochs):
  ...
  for epoch in range(epochs):
    ...
    train_acc_hist.append(train_acc.cpu().cpu().detach().numpy())
    val_loss_hist.append(val_loss.cpu().detach().numpy())
    val_acc_hist.append(val_acc.cpu().detach().numpy())
...
trainValLoop(model, loss_fn, optimiser, epochs)
