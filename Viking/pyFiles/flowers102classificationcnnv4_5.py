# -*- coding: utf-8 -*-
"""Flowers102ClassificationCNNv4.5.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/ChrisO03/IMLO-CourseWork/blob/main/CNNv4.5/Flowers102ClassificationCNNv4.5.ipynb
"""
...
class CNNv4(nn.Module):
  def __init__(self, input_shape: int, hidden_units: int, output_shape: int):
    ...
    self.finalClass = nn.Sequential(
        nn.Linear(in_features=output_shape*3,
                  out_features=256),
        nn.ReLU(),
